...
class Config:
    ...
    API_KEY = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX"  # need to complete the api key
...
class Config:
    ...
    # API KEYS
    GEMINI_API_KEY = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX" # <--- PASTE KEY HERE
    SEMANTIC_SCHOLAR_KEY = "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX" # Optional
